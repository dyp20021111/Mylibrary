    ...
    <style>
        * {
        ...
        html {
            ...
            margin: 0;
            padding: 0;
            background: url("${pageContext.request.contextPath}/image/12.png") no-repeat 0px 0px;
...
<div id="loginDiv">
    <form action="${pageContext.request.contextPath}/user/addUser" method="post" onsubmit="return checkForm()">
        <h1>注册</h1>
        <p>用户id&nbsp;&nbsp;&nbsp;&nbsp;<input id="userid" name="userid" type="text" autofocus required><label id="id_trip"></label></p>
        ...
        <p>描述&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="detail" name="detail" type="detail" required><label id="detail_trip"></label></p>
...
<div style="text-align: center">
    <form style="position: relative; width: 80px; height: 80px; left: 50%;margin-top: 100px" action="${pageContext.request.contextPath}/user/toindex" >
